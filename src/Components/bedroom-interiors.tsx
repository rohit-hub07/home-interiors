...
const STORAGE_KEY = 'bedroom-interiors-slides';
    ...
    <div className="bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 flex-1">Bedroom Interiors For Comfort And Style</h2>
          {userId && (
          ...
          <div className="flex justify-center gap-4 md:gap-6" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
            {visibleSlides.map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`${visibleCount === 1 ? 'w-[90%]' : 'w-full md:w-1/3'} relative`}
                >
                  <div className="relative">
                    <img
                      src={item.img}
